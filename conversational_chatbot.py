...
if 'final_documents' not in st.session_state:
    st.session_state.loader = PyPDFLoader("./Onasi RCM.pdf")
...
# Current input area for a new question
...
if st.button("Ask"):
    if model_input:
        ...
        # Clear the current input and rerun to update the display with the new disabled input
        st.rerun()
